'use client'; // This line must remain at the top because of styled-jsx or other client-side features.

import Link from 'next/link';

// Remove the export const metadata = { ... } from this file.
// export const metadata = { // <-- REMOVE THIS BLOCK
//   title: 'Indirect Taxation Services - Tax Consulting',
//   description: 'Our expert services for Indirect Taxation including GST Registration & Filing, GST Refund & LUT Processing, Reconciliation, GST Audit, RCM & ISD Consulting.',
// }; // <-- REMOVE THIS BLOCK

export default function IndirectTaxOverviewPage() {
