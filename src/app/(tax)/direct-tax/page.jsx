'use client'; // Mark as a Client Component for styled-jsx and interactive elements

import Link from 'next/link';

// Removed metadata export as it's not allowed in Client Components in Next.js App Router.
// export const metadata = {
//   title: 'Direct Taxation Services - Tax Consulting',
//   description: 'Our core direct taxation services include Income Tax Return Filing, Capital Gains, TDS Compliance, Advance Tax Management, and Tax Planning & Advisory.',
// };

export default function DirectTaxOverviewPage() {
  // Define services as an array of objects for easier mapping and icon assignment
