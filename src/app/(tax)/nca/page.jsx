// components/NationalCompetentAuthority.js
'use client'; // Ensure this is a client component if it uses hooks/interactive elements

import React from 'react';
import Link from 'next/link';

const NationalCompetentAuthority = () => {
  return (
...
export default NationalCompetentAuthority;