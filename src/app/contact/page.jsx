// pages/contact-us.js OR components/ContactUsPage.js
...
const ContactUsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-inter text-gray-900 overflow-hidden">
      ...
      {/* <Head>
        <title>Contact Perficio - Chartered Accountant Firm</title>
        <meta name="description" content="Get in touch with Perficio for expert financial and legal advisory services." />
      ...
      <main className="w-full max-w-7xl mx-auto py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8 space-y-12 sm:space-y-16 lg:space-y-20">
        ...
        <section className="relative w-full py-20 px-6 rounded-xl overflow-hidden shadow-xl"
          style={{
            background: 'linear-gradient(135deg, #FDF7E7 0%, #FAEAB5 100%)', // Soft warm gradient
          }}>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 font-inter">
                    <a href="tel:+91[Your Phone Number]" className="hover:underline">+91 [Your Phone Number]</a><br/>
        ...
        <section className="bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-100">
          ...
          <div className="w-full h-80 rounded-lg overflow-hidden border border-gray-200">
            {/* Replace with your actual Google Maps embed code or a link */}
            <iframe
              ...
              title="Our Location"
            ></iframe>
            {/* Example: Replace the iframe src with your actual location. You can get embed code from Google Maps. */}
            {/* If you prefer just a link: */}
            {/* <div className="text-center mt-4">
              <a href="https://maps.app.goo.gl/YOUR_GOOGLE_MAPS_LINK" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-inter">View on Google Maps</a>
            </div> */}
          </div>
        </section>
